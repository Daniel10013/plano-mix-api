...
router.get('/', authenticate, controller.getAllClassification)
...
//rotas do segmento
router.get('/segment', authenticate, controller.getAllSegment)
...
router.get('/activity', authenticate, controller.getAllActivity)
